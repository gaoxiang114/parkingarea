					...
					<div class="well">
					    <div id="myTabContent" class="tab-content">
					      <div class="tab-pane active in" id="home">
							    <form id="myForm" action="${req.contextPath}/manager/services/doAddService" method="post" onsubmit="return mySubmit();">
							        <label>标题</label>
							        <input type="text" id="serviceTitle" name="serviceTitle" value="" class="input-xlarge">
							        <label>内容</label>
							        <textarea id="editor1" name="serviceContent" class="ckeditor" rows="10" cols="80"></textarea>
							         <label>服务图标地址</label>
