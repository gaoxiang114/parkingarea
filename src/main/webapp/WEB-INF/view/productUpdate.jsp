					...
					<div class="well">
					    <div id="myTabContent" class="tab-content">
					      <div class="tab-pane active in" id="home">
							    <form id="myForm" action="${req.contextPath}/manager/product/doUpdateProductPage" method="post" onsubmit="return mySubmit();">
							        <input type="hidden" name="proId" value="${product.proId}">
							        <label>标题</label>
							        <input type="text" id="proTitle" name="proTitle" value="${product.proTitle}" class="input-xlarge">
							        <label>内容</label>
							        <textarea id="editor1" name="proContent" class="ckeditor" rows="10" cols="80">${product.proContent}</textarea>
							        <label>产品图标地址</label>
							        <input type="text" id="imageUrl" name="imageUrl" value="${product.imageUrl}" class="input-xlarge">
							        <label>首页显示设置</label>
							        <label class="radio">
