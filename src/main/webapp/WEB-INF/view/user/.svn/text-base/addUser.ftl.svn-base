...
<body><center>
	${message}
	<form action="${req.contextPath}/user/addOne" method="post" id="frm">
		...
		<table border ="1">
			...
			<#list roleList as role>
				<input type="checkbox" name="roleId" id="roleId" value="${role.roleId}">${role.roleName}			
			</#list>
			</td>
			<td><span id="roleMsg"></span></td></tr>
			<tr>
			
			<tr>
			<td colspan="3"><center>
								<input type="button"  value="提交" id="bn" onclikc="mySubmit()" />
