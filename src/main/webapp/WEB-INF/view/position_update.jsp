  ...
  <body class=""> 
    ...
    <div class="content">
			        <div class="header">
			            ...
			            <h1 class="page-title">修改停车位</h1>
			        </div>
			        
			                <ul class="breadcrumb">
			            <li><a href="${req.contextPath}/manager/user/index">主页</a> <span class="divider">/</span></li>
			            <li><a href="${req.contextPath}/manager/product/productList">停车位管理</a> <span class="divider">/</span></li>
			            <li class="active">修改停车位名字</li>
			        </ul>
					...
					<div class="well">
					    <div id="myTabContent" class="tab-content">
					      <div class="tab-pane active in" id="home">
							    <form id="myForm" action="${req.contextPath}/position/doPositionUpdate" method="post" onsubmit="return submitForm();">
							        <input type="hidden" name="parkingId" id="parkingId" value="${position.parkingId}"/>
							        <table style="width:100% ">
									    	<tr>
									    		<td style="width: 100px;">停车位名称   ：</td>
									    		<td><input type="text" name="parkingNum" id="parkingNum" value="${position.parkingNum}"/></td>
									    	</tr>
									        <tr>
									            <td colspan="3">
									            	<input type="submit"  value="保存" class="btn btn-primary" style="margin-left: 74px;"/>
    ...
    <script type="text/javascript">
        ...
        function submitForm(){
        	...
        	if($("#parkingNum").val() == "" || $("#parkingNum").val() == null){
        		...
        		$.ajax({
 			       type: 'POST',  
 			       url: projectName+'/carInOut/checkPositionExist?rand='+Math.random(),
 			       data:{"carNum":val},
 			       async:false,
