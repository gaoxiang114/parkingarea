  ...
  <body class=""> 
    ...
    <div class="content">
			        <div class="header">
			            ...
			            <h1 class="page-title">解决方案添加</h1>
			        </div>
			        
			                <ul class="breadcrumb">
			            <li><a href="${req.contextPath}/managerr/user/index">主页</a> <span class="divider">/</span></li>
			            <li><a href="${req.contextPath}/managerr/solution/solutionList">解决方案列表</a> <span class="divider">/</span></li>
			            <li class="active">解决方案添加</li>
			        </ul>
					...
					<div class="well">
					    <div id="myTabContent" class="tab-content">
					      <div class="tab-pane active in" id="home">
							    <form id="myForm" action="${req.contextPath}/managerr/solution/doSolutionAdd" method="post" onsubmit="return mySubmit();">
							        <label>标题</label>
							        <input type="text" id="soluTitle" name="soluTitle" value="" class="input-xlarge">
							        <label>内容</label>
							        <textarea id="editor1" name="soluContent" class="ckeditor" rows="10" cols="80"></textarea>
