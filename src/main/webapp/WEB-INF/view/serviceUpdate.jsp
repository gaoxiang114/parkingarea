  ...
  <body class=""> 
    ...
    <div class="content">
			        <div class="header">
			            ...
			            <h1 class="page-title">服务修改</h1>
			        </div>
			        
			                <ul class="breadcrumb">
			            <li><a href="${req.contextPath}/manager/user/index">主页</a> <span class="divider">/</span></li>
			            <li><a href="${req.contextPath}/manager/services/servicesList">服务列表</a> <span class="divider">/</span></li>
					...
					<div class="well">
					    <div id="myTabContent" class="tab-content">
					      <div class="tab-pane active in" id="home">
							    <form id="myForm" action="${req.contextPath}/manager/services/doUpdateService" method="post" onsubmit="return mySubmit();">
							        <input type="hidden" name="id" value="${services.id}">
							        <label>标题</label>
							        <input type="text" id="serviceTitle" name="serviceTitle" value="${services.serviceTitle}" class="input-xlarge">
							        <label>内容</label>
							        <textarea id="editor1" name="serviceContent" class="ckeditor" rows="10" cols="80">${services.serviceContent}</textarea>
							         <label>服务图标地址</label>
							        <input type="text" id="imageUrl" name="imageUrl" value="${services.imageUrl}" class="input-xlarge">
							        <label>首页显示设置</label>
							        <label class="radio">
