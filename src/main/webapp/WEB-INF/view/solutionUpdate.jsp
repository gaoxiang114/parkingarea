...
<html lang="en">
  <head>
	...
	<script>
  		function mySubmit(){
  			var soluTitle = $("#soluTitle");
  			var editor_data = CKEDITOR.instances.editor1.getData();
  			if(is_empty(soluTitle.val())){
  				alert("请输入标题");
  				soluTitle.focus();
  				return false;
  			}
  ...
  <body class=""> 
    ...
    <div class="content">
			        <div class="header">
			            ...
			            <h1 class="page-title">解决方案修改</h1>
			        </div>
			        
			        <ul class="breadcrumb">
			            <li><a href="${req.contextPath}/manager/user/index">主页</a> <span class="divider">/</span></li>
			            <li><a href="${req.contextPath}/manager/solution/solutionList">解决方案列表</a> <span class="divider">/</span></li>
			            <li class="active">解决方案修改</li>
			        </ul>
					...
					<div class="well">
					    <div id="myTabContent" class="tab-content">
					      <div class="tab-pane active in" id="home">
							    <form id="myForm" action="${req.contextPath}/manager/solution/doSolutionUpdate" method="post" onsubmit="return mySubmit();">
							        <input type="hidden" name="soluId" value="${solution.soluId}">
							        <label>标题</label>
							        <input type="text" id="soluTitle" name="soluTitle" value="${solution.soluTitle}" class="input-xlarge">
							        <label>内容</label>
							        <textarea id="editor1" name="soluContent" class="ckeditor" rows="10" cols="80">${solution.soluContent}</textarea>
							         <label>解决方案图标地址</label>
							        <input type="text" id="imageUrl" name="imageUrl" value="${solution.imageUrl}" class="input-xlarge">
							        <label>首页显示设置</label>
							        <label class="radio">
